...
export default function CustomHeader({
  ...
  return (
    <div className="sticky top-0 z-40 flex w-full flex-col items-center justify-between gap-5 bg-dove-neutral-100/80 px-12 py-4 drop-shadow-md sm:flex-row xl:px-64">
      <h1>{title}</h1>
      {buttonType === "none" && (
        <a
